  ...
  create or replace   view analytics.dbt_kcoapman.order_items
  
   as (
    with orders as (
    
    select * from analytics.dbt_kcoapman.stg_tpch_orders

),

line_item as (

    select * from analytics.dbt_kcoapman.stg_tpch_line_items
