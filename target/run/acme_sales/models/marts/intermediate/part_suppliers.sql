  ...
  create or replace   view analytics.dbt_kcoapman.part_suppliers
...
supplier as (
    ...
    select * from analytics.dbt_kcoapman.stg_tpch_suppliers

),

part_supplier as (

    select * from analytics.dbt_kcoapman.stg_tpch_part_suppliers
